...
namespace GmrFinder.Tests.Data;

public class MongoServiceTests
{
    private readonly IMongoDbClientFactory _connectionFactoryMock = Substitute.For<IMongoDbClientFactory>();
    private readonly IMongoCollection<TestModel> _collectionMock = Substitute.For<IMongoCollection<TestModel>>();
